...
<div class="sidebar">
    <div class="sidebar-brand">
        <img src="<?= BASE_URL ?>/assets/img/Orion.png?v=<?= ASSET_VER ?>" alt="Logo" style="height:70px;width:auto;margin-bottom:8px;">
        <h4><?= getSetting('school_name', 'أوريون') ?></h4>
        <small class="text-white-50">Orion Aden Institute</small>
    </div>
    <ul class="sidebar-nav">
        ...
        <?php if (hasPermission('messaging', 'send')): ?>
        <li class="nav-item">
            <a href="<?= BASE_URL ?>/modules/messaging/index.php" class="nav-link <?= $module === 'messaging' ? 'active' : '' ?>">
