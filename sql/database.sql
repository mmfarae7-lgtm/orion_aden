-- Orion Aden Institute - Database Schema
-- InfinityFree compatible version
-- Import this file via phpMyAdmin (select your database first, then click Import)
...
CREATE TABLE IF NOT EXISTS `enrollments` (
  ...
  `attendance_grade` VARCHAR(5) DEFAULT NULL,
  `vocabulary` VARCHAR(5) DEFAULT NULL,
  `writing` VARCHAR(5) DEFAULT NULL,
  `speaking` VARCHAR(5) DEFAULT NULL,
...
('sms_api_key', '', 'messaging'),
('sms_sender_name', 'Orion', 'messaging'),
('sms_api_url', '', 'messaging'),
('twilio_account_sid', '', 'messaging');

-- ALTER queries for existing databases (run once in phpMyAdmin):
-- ALTER TABLE courses ADD schedule_days VARCHAR(100) DEFAULT NULL AFTER schedule_time;
-- ALTER TABLE students ADD created_by INT(11) UNSIGNED DEFAULT NULL AFTER updated_at;
-- ALTER TABLE teachers ADD created_by INT(11) UNSIGNED DEFAULT NULL AFTER updated_at;
-- ALTER TABLE courses ADD created_by INT(11) UNSIGNED DEFAULT NULL AFTER updated_at;
-- ALTER TABLE fees ADD created_by INT(11) UNSIGNED DEFAULT NULL AFTER created_at;
-- ALTER TABLE enrollments ADD created_by INT(11) UNSIGNED DEFAULT NULL AFTER created_at;
-- ALTER TABLE users ADD created_by INT(11) UNSIGNED DEFAULT NULL AFTER updated_at;
