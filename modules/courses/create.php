...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    requireCsrf();
    try {
        insert("INSERT INTO courses (course_code, course_name, description, teacher_id, credit_hours, fee, max_students, room, schedule_time, schedule_days, created_by) VALUES (?,?,?,?,?,?,?,?,?,?,?)", [
            ...
            trim($_POST['room'] ?: ''), trim($_POST['schedule_time'] ?: ''), trim($_POST['schedule_days'] ?: ''),
            $_SESSION['user_id']
        ]);
            ...
            <form method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="room" class="form-control" placeholder="مثال: قاعة A1">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">وقت الدورة</label>
                        <input type="text" name="schedule_time" class="form-control" placeholder="مثال: 10:00 - 12:00">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">أيام الدورة</label>
                        <input type="text" name="schedule_days" class="form-control" placeholder="مثال: سبت - اثنين - أربعاء">
                    </div>
                    <div class="col-md-4">
