...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    requireCsrf();
    insert("INSERT INTO fees (fee_name, amount, description, frequency, created_by) VALUES (?,?,?,?,?)", [
        trim($_POST['fee_name']), $_POST['amount'], trim($_POST['description']), $_POST['frequency'],
        $_SESSION['user_id']
    ]);
    setFlash('success', 'تم إضافة الرسم بنجاح');
...
<div class="main-content">
    <nav class="topbar d-flex justify-content-between align-items-center">
        <div><button class="btn btn-link d-md-none" id="sidebarToggle"><i class="bi bi-list fs-4"></i></button><h5 class="mb-0 d-inline">إضافة رسم</h5></div>
    ...
    <div class="page-content">
        <div class="table-container">
            <form method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label">اسم الرسم <span class="text-danger">*</span></label>
