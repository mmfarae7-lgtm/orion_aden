...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    requireCsrf();
    try {
        insert("INSERT INTO teachers (teacher_code, first_name, last_name, gender, date_of_birth, phone, email, address, qualification, specialization, hire_date, salary, notes, created_by) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [
