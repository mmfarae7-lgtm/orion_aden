...
$users = getRows("SELECT u.*, creator.full_name AS creator_name FROM users u LEFT JOIN users creator ON u.created_by = creator.id ORDER BY u.created_at DESC");
        ...
        <div class="table-container">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="usersTable">
                    ...
                    <tbody>
                        <?php if (empty($users)): ?>
                            <tr><td colspan="9" class="text-center text-muted">لا يوجد مستخدمين</td></tr>
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><?= $u['last_login'] ?? '---' ?></td>
                                <td class="small text-muted"><?= htmlspecialchars($u['creator_name'] ?? '---') ?></td>
                                <td>
